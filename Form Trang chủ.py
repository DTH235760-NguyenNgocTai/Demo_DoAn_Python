...
top_frame = tk.Frame(root, bg = "#001f4d") 
...
# Nút SIGN IN
btnsign_in = tk.Button(top_frame, text = "SIGN IN", bg = "blue", fg = "white", font = ("Arial", 12, "bold"))
btnsign_in.place(x = 60, y = 12, width = 100, height = 30)

# Combobox Lựa chọn
combo_values = ["Đặt phòng", "Trả phòng"]
